...
setup(
  name = 'despell',         # How you named your package folder (MyLib)
  packages = ['despell'],   # Chose the same as "name"
  version = '0.1.0',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'TYPE YOUR DESCRIPTION HERE',   # Give a short description about your library
  author = 'Greg Feldmann',                   # Type in your name
  author_email = 'felga001@mymail.unisa.edu.au,      # Type in your E-Mail
  url = 'https://github.com/phosgene89/despell',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/phosgene89/despell/archive/v0.1.0.tar.gz',    # I explain this later on
